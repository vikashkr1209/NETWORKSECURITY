...
class DataTransformation:
    ...
    def get_data_transformer_object(cls) -> Pipeline:
        """
        It initialise a KNNImputer object with the paramter secified in the training_pipeline.py file
        and it return a Pipeline object with the KNNImputer object as the first step
        Args:
